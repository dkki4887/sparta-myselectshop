...
@WebMvcTest(
        controllers = {UserController.class, ProductController.class}, //테스트 할 컨트롤러
        excludeFilters = { //제외할것들 지정...
...
class UserProductMvcTest {
    private MockMvc mvc; //가짜로 Http 요청 날릴 수 있음
...
//    @MockBean -> @MockitoBean
    ...
    @BeforeEach
    public void setup() {
        //MockSpringSecurityFilter로 생성한 가짜 필터 넣어주기
